...
public class JiraReferenceResolver : IJiraReferenceResolver
{
    ...
    public Task<bool> JiraReferenceExistsInCommentsAsync(GitHubIssueIdentifier gitHubIssueIdentifier, out Issue jiraIssue)
    {
        ...
        IReadOnlyList<IssueComment> comments = gitHubClient.Issue.Comment.GetAllForIssue(gitHubIssueIdentifier.Owner, gitHubIssueIdentifier.RepoName,
            gitHubIssueIdentifier.IssueNumber).Result;
